...
from banchar import views as banchar_views
...
urlpatterns = [
	...
	path('profile/<int:profile_id>/', tasty_views.ProfileView.as_view(), name='profile'),

	path(
		'pickup/create',
		banchar_views.PickupRequestCreateView.as_view(),
		name='pickup-create'
	),
	path(
		'pickup/history',
		banchar_views.UserPickupHistory.as_view(),
		name='pickup-history'
	),
]
